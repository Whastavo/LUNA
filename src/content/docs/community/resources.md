---
title: Resources
description: Tools and marketplaces to enhance your Luna experience.
---

# Resources

A collection of tools and marketplaces that pair well with Luna. Whether you want to create your own avatar from scratch or find the perfect accessories, these resources have you covered.
...
- Export directly to `.vrm` format, ready to load into Luna
- Available on Windows, macOS, and iPad
- Completely free to use

VRoid Studio is the easiest way to go from zero to a personalized avatar. Design your character, export the VRM file, and drop it into Luna.
...
Many creators sell VRoid-compatible outfits and accessories on BOOTH that you can import into VRoid Studio, customize, and then export as a VRM for use in Luna.
