<script lang="ts">
	...
	const navItems = $derived([
		{ href: localPath('app', '/settings/persona'), label: 'Personaje', icon: 'persona' },
		{ href: localPath('app', '/settings/display'), label: 'Pantalla', icon: 'monitor' },
		...
		{ href: localPath('app', '/settings/data'), label: 'Datos', icon: 'database' },
		{ href: localPath('app', '/settings/developer'), label: 'Desarrollador', icon: 'code' }
	]);
